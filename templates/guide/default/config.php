            ...
            <form class="layui-form" lay-filter="form">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" placeholder="留空则使用默认用户站点配置的主标题"
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="p1" placeholder="留空则使用默认用户站点配置的描述" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="bg_img" placeholder="请输入背景图URL,留空则使用默认背景图"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
