                                ...
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="link_list"
                                               data-title="链接列表" data-icon="fa fa-link">
                                                <i class="fa fa-link"></i>
                                                <cite>链接列表</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="link_add"
                                               data-title="添加链接" data-icon="fa fa-plus-square-o">
                                                <i class="fa fa-plus-square-o"></i>
                                                <cite>添加链接</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="SiteSetting"
                                               data-title="站点设置" data-icon="fa fa-cog">
                                                <i class="fa fa-cog"></i>
                                                <cite>站点设置</cite>
                                            </a>
                                        </div>
                                        <?php if (check_purview('theme_in', 1)) { ?>
                                            <div class="layui-col-xs3 layuimini-qiuck-module">
                                                <a href="javascript:;" layuimini-content-href="theme_home"
                                                   data-title="主题设置" data-icon="fa fa-magic">
                                        ...
                                        <?php } ?>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="category_list"
                                               data-title="分类管理" data-icon="fa fa-list-ul">
                                        ...
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="UserPassword"
                                               data-title="修改密码" data-icon="fa fa-key">
                                                <i class="fa fa-key"></i>
                                                <cite>修改密码</cite>
                                            </a>
                                        </div>
                    ...
                    <div class="layui-card-body layui-text">
                        <table class="layui-table">
                            ...
                            <tr>
                                <td>用户交流</td>
                                <td><a target="_blank"
                                       href="https://qm.qq.com/cgi-bin/qm/qr?k=LaIzFK2hfTYBZGR0cKvW3xZL6aNgcSXH&jump_from=webapi&authKey=LHh1NtAiGdK0wNyoZiHWrzAZTWWq26YgAwX0Ak7rBWchh6Y5ocUX/0cCXLMXvq/k"
                                       title="TwoNav - 技术交流">QQ群：695720839</a>
                                </td>
                            </tr>
                            <tr>
                                <td>技术支持</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;
                                    <a href="<?php echo './?c=' . $USER_DB['Login'] . '&u=' . U; ?>" target="_blank">TwoNav
                                        - 登录</a>
                                    &nbsp;
                                    <i class="fa fa-arrow-left layui-hide-xs" style="color: #ff5722;">&nbsp;<span
                                            style="color: #ff5722;"
                                            title="收藏专属入口可避免无法登录后台的情况">建议收藏</span></i>
                                </td>
                            <tr>
                            </tbody>
                        </table>
