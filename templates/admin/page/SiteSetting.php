        ...
        <form class="layui-form" lay-filter="form">
            <div class="layui-form layuimini-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux">直连模式无法统计点击数且无法使用备用链接,但它响应最快!
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="number" name="max_link" class="layui-input" value="0" placeholder="输入范围: 0-100"
                               lay-verify="required">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="site_icon" class="layui-input"
                               placeholder="浏览器显示的图标,留空则使用默认图标!" style="padding-left: 95px;">
                        <div style="position: absolute; top:0px;">
                            <span><a class="layui-btn layui-btn-primary"
                                     id="<?php echo check_purview('Upload_icon', 1) ? 'upload' : 'no_purview' ?>"><i
                ...
                <?php } ?>
                <div class="layui-form-item">
                    <button type="button" class="layui-btn layui-btn-primary layui-border-black" id="help"
                            sort_id="7968924">帮助
                    </button>
                    <?php if ($global_config['Default_User'] != U) { ?>
                        <button type="button" class="layui-btn layui-btn-primary layui-border-black" id="sdhp" data=>
                            设为默认主页
                        </button>
                    <?php } ?>
...
<script>
    layui.use(['jquery', 'form', 'upload'], function () {
        ...
        upload.render({
            ...
            , done: function (res) {
                if (res.code == 1) {
                    layer.alert("您可能要清除浏览器缓存(CTRL+F5)才会看到新图标!", {
                        icon: 1,
                        title: '上传成功',
                        anim: 2,
                        closeBtn: 0,
