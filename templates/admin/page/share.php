    ...
    <div class="layuimini-main">
        ...
        <div class="layui-inline layui-form" style="padding-bottom: 5px;">
            <div class="layui-input-inline">
                <input class="layui-input" name="keyword" id="keyword" placeholder='请输入标识/名称/备注'
                       autocomplete="off">
            </div>
...
<ul class="data" style="margin-top:18px;display:none;padding-right: 10px;">
    <form class="layui-form layuimini-form" lay-filter="data">
        ...
        <div class="layui-form-item" id="cf">
            ...
            <div class="layui-input-block">
                <input type="text" name="category_data" id="category_data" readonly="readonly"
                       placeholder="点击此处选择需要分享的内容" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item" id="lf" style="display:none;">
            <label class="layui-form-label">分享内容</label>
            <div class="layui-input-block">
                <input type="text" name="link_data" id="link_data" readonly="readonly"
                       placeholder="点击此处选择需要分享的内容" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="expire" placeholder="有效期,留空为永久" readonly="readonly" class="layui-input" id="expire"
...
<script>
    layui.use(['form', 'table', 'laydate', 'tableSelect'], function () {
        ...
        table.on('toolbar(table)', function (obj) {
            ...
            if (event == 'del') {
                sid = checkStatus.data.map(function (value) {
                    return value.sid;
                });
        ...
        //书签选择
        function load_tableSelect(searchPlaceholder, name, url, elem, limit, limits) {
            tableSelect.render({
                elem: elem,
                checkedKey: 'id',
                searchType: 'more',
