    ...
    <div class="layuimini-main">
        <form class="layui-form" lay-filter="form">
            <div class="layui-form layuimini-form layui-form-pane">
                <blockquote class="layui-elem-quote layui-text" style="">注意: 出于账号安全考虑,在您成功保存本页设置后,您在其他浏览器的登录保持都将失效
                    ( 需重新登录 )
                </blockquote>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux">部分主题和插件需设为兼容+开放模式 <a href="javascript:;"
                                                                                                    layuimini-content-href="Token"
                                                                                                    data-title="Token"><font
                                color="red"> 获取API ( Token )</font></a></div>
                </div>
