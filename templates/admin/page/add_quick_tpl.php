...
<div class="quick-main">
    ...
    <form class="layui-form" lay-filter="form">
        <div class="list"><input type="text" name="url" id="url" required lay-verify="required" placeholder="URL"
                                 autocomplete="off"></div>
        <div class="list"><input type="text" name="title" id="title" required lay-verify="required" placeholder="标题"
                                 autocomplete="off"></div>
        <div class="list">
        ...
        <div class="list list-2">
            <div class="li">是否私有<input type="checkbox" lay-skin="switch" lay-text="是|否" name="property" value="1">
            </div>
        </div>
        <div class="list">
