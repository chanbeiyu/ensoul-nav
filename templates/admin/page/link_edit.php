    ...
    <div class="layuimini-main">
        <form class="layui-form layuimini-form" lay-filter="form">
            ...
            <div class="layui-form-item" style="display:none;">
                <label class="layui-form-label required">链接ID</label>
                <div class="layui-input-block">
                    <input type="text" id="lid" name="lid" required lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="url" id="url" name="url" lay-verify="required" placeholder="请输入有效链接"
                           autocomplete="off" class="layui-input obtn">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="title" name="title" lay-verify="required" placeholder="请输入链接名称"
                           autocomplete="off" class="layui-input obtn">
                    <div style="position: absolute; top:0px;">
                        <span><a class="layui-btn layui-btn-primary" onclick="get_link_info()"><i
                                    class="fa fa-pencil"></i> 识别</a></span>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block layuimini-upload">
                    <input type="text" id="icon" name="icon" autocomplete="off" class="layui-input obtn"
                           placeholder="自定义链接图标,留空则使用API接口!">
                    <div style="position: absolute; top:0px;">
                        <span><a class="layui-btn layui-btn-primary"
                                 id="<?php echo check_purview('Upload_icon', 1) ? 'up_icon' : 'no_purview' ?>"><i
            ...
            <div class="layui-form-item">
                <div class="layui-input-block layui-btn-group">
                    ...
                    <button class="layui-btn layui-btn-normal" type="button" id="reset">重置</button>
                    <button class="layui-btn layui-btn-normal" lay-submit lay-filter="edit_link" id="edit_link">更新
                    </button>
                </div>
            </div>
        </form>
...
<script>
    var form_data = <?php echo json_encode($link);?>;
</script>
<?php load_static('js'); ?>
