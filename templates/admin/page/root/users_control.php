    ...
    <form class="layui-form layuimini-form" lay-filter="add">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" lay-verify="required" lay-reqtext="分组名称不能为空"
        ...
        <div class="layui-form-item" id="fcode">
            ...
            <div class="layui-input-block">
                <input type="text" name="code" id="code" lay-verify="required|code" lay-reqtext="代号不能为空"
                       placeholder="请输入代号(字母和数字)" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="allow_list" id="allow_list" readonly="readonly" placeholder="点击弹出选择列表"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-mid layui-word-aux">用户注册后初始数据和蓝图用户相同&nbsp;<a href="javascript:;"
                                                                                                onclick="tips('生效条件: 当前用户组作为默认分组时或注册码绑定当前分组<br />用途说明: 用户注册后初始数据和蓝图用户相同!<br />初始数据: 分类/链接/站点设置<br />&emsp;&emsp;&emsp;&emsp;&emsp;登录配置(不含二级密码)<br />&emsp;&emsp;&emsp;&emsp;&emsp;默认模板(不含模板配置)<br />注意事项: 请确保该用户没有隐私数据<br />其他: 留空则以默认设置创建初始数据')"
                                                                                                style="color: #e41010;">查看帮助</a>
            </div>
        </div>
        ...
        table.on('tool(table)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                form.val('add', {
                    ...
                    "name": data.name,
                    'allow_code_list': JSON.stringify(data.codes),
                    'uname': data.uname
                });
                index = layer.open({
                    type: 1,
