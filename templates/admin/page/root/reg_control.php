...
<ul class="generate" style="margin-top:18px;display:none;padding-right: 10px;">
    <form class="layui-form " lay-filter="generate">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" id="number" name="number" required lay-verify="required|generate_number"
                       placeholder="请输入生成数量1-100" autocomplete="off" class="layui-input" value="1">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="content"
                          placeholder="可以填获取注册码的地址,留空则不显示!非http开头时将作为提示信息弹出!" rows="7"
                          class="layui-textarea"><?php echo get_db('global_config', 'v', ['k' => 'reg_tips']); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
...
<script>
    ...
    layui.use(['table', 'layer', 'form'], function () {
        ...
        form.on('submit(generate)', function (data) {
            $.post(get_api('write_regcode', 'generate'), {
                'number': data.field.number,
                'group': data.field.UserGroup,
                'regcode_length': 8
