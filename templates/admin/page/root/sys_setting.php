    ...
    <div class="layuimini-main">
        <form class="layui-form" lay-filter="form">
            <div class="layui-form layuimini-form layui-form-pane">
                <blockquote class="layui-elem-quote layui-text" style="">1.带*号的选项属<a
                        href="https://gitee.com/tznb/OneNav/wikis/%E8%AE%A2%E9%98%85%E6%9C%8D%E5%8A%A1%E6%8C%87%E5%BC%95"
                        target="_blank">授权用户</a>专享<br/>2.原OneNav Extend的部分配置已下放到用户组配置中<br/>3.如果您不理解选项的作用请勿乱改
                </blockquote>

                <div class="layui-form-item">
                    <label class="layui-form-label">默认用户</label>
                    <div class="layui-input-inline">
                        <input type="text" name="Default_User" lay-verify="required" lay-reqtext="默认用户不能为空"
                               placeholder='admin' autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">默认主页的账号,优先级:Get>Cookie/Host>默认用户>admin
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="default_UserGroup" lay-reqtext="默认用户不能为空" placeholder='default'
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="Register" lay-verify="required" lay-reqtext="注册入口不能为空"
                               placeholder='register' autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="Login" lay-verify="required" lay-reqtext="登录入口不能为空"
                               placeholder='login' autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">修改可以防止被爆破,修改请记好入口名,否则无法登录后台
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="Libs" lay-verify="required"
                               lay-reqtext="静态路径不能为空,填错会导致无法正常加载网页!默认./static"
                               placeholder='./static' autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">默认为./static 即本地服务器!可以使用CDN来提高加载速度
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux">
                        开启将禁止服务器访问互联网,部分功能将被禁用(如:更新提示,公告,在线主题,链接识别,书签克隆等)
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux">
                        以二级域名的形式直接进入用户主页,需配置域名泛解析和服务器泛域名绑定
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="copyright" placeholder='Copyright © TwoNav' autocomplete="off"
                               class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">主页底部显示的版权信息,开发不易,免费用户请保留版权,谢谢
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="global_footer" class="layui-textarea"
                                  placeholder='例如备案号,统计代码等,支持HTML,JS,CSS'></textarea>
                    </div>
                </div>
