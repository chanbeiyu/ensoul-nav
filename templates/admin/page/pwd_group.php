    ...
    <form class="layui-form" lay-filter="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" lay-reqtext="分组名称不能为空"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="password" lay-verify="required" lay-reqtext="分组密码不能为空"
                       placeholder="请输入分组密码" class="layui-input" value="<?php echo uniqid() ?>">
            </div>
        </div>
        <div class="layui-form-item">
