...
<div class="layuimini-container">
    <div class="layuimini-main">
        <div class="layui-form layuimini-form layui-form-pane">
            <blockquote class="layui-elem-quote layui-text" style="">注意: 在您成功修改密码后,您在其他浏览器的登录保持都将失效
                ( 需重新登录 )
            </blockquote>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="NewPassword2" lay-verify="required" lay-reqtext="新的密码不能为空"
                           placeholder="请输入新的密码" value="" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['jquery', 'form', 'miniTab'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post(get_api('write_user_password'), {
                Password: $.md5(data.field.Password),
                NewPassword: $.md5(data.field.NewPassword)
