        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="Notice"
                          placeholder="显示在收录页的公告使用HTML代码编写(如有拦截提示,请暂时关闭防XSS脚本和防SQL注入)"
                          rows="5" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">使用说明</label>
            <div class="layui-form-mid ">部分主题没有收录入口,请自行添加到链接或者底部等你认为合适的地方!前往<a
                    style="color:#3c78d8" target="_blank" href="./index.php?c=apply&u=<?php echo $u ?>" target="_blank">申请收录</a>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">安全限制</label>
            <div class="layui-form-mid ">1.禁止含有特殊字符<'&">等 &nbsp; 2.SQL和XSS相关的敏感词 &nbsp; 3.限制超过256个字符
                <br/> 4.提交限频:IP/24小时/5次 (删除记录可恢复)
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
...
//用户行工具栏事件
        table.on('tool(apply_list)', function (obj) {
            ...
            if (obj.event === 'operation') {
                ...
                if (data.state == 0) {
                    menu = [{title: '详情', id: 0}, {title: '编辑', id: 1}, {title: '通过', id: 2}, {
                        title: '拒绝',
                        id: 3
                    }, {title: '删除', id: 4}];
