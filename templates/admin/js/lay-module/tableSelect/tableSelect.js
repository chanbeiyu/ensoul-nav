layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        opt.table.page = opt.table.page == true ? true : false;
        opt.table.height = opt.height || 315;
        opt.rowDouble = opt.rowDouble == true ? true : false;
        //最小宽度
        ...
        elem.off('click').on('click', function (e) {
            ...
            overWidth && tableBox.css({'left': '0px', 'right': '5px'});

            if (elem.width() < 530) {
                tableBox.css({'right': '0px', 'left': '0px'});
            }
            //关键词搜索
