layui.use(['form', 'table', 'dropdown', 'miniTab'], function () {
    ...
    //关键字回车搜索
    $('#link_keyword').keydown(function (e) {
        if (e.keyCode === 13) {
            link_search();
        }
    });
    ...
    table.on('edit(table)', function (obj) {
        $.post(get_api('write_link', 'fast_edit'), {
            'lid': obj.data.lid,
            'field': obj.field,
            'value': obj.value
