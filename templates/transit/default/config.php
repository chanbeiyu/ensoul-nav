            ...
            <form class="layui-form layui-form-pane" lay-filter="form">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="menu" placeholder="请参考帮助文档进行设置！" rows="4"
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="a_d_1" placeholder="请参考帮助文档进行设置！" rows="2"
                                  class="layui-textarea"></textarea>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="a_d_2" placeholder="请参考帮助文档进行设置！" rows="2"
                                  class="layui-textarea"></textarea>
                    </div>
                </div>
                ...
                <div class="layui-form-item" style="padding-top: 10px;">
                    <div class="layui-input-block">
                        ...
                        &nbsp; <a href="https://gitee.com/tznb/TwoNav/wikis/pages?sort_id=7968712&doc_id=3767990"
                                  target="_blank">过渡页使用说明</a>
                    </div>
                </div>
            </form>
        </div>
