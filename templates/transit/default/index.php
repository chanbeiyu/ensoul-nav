    ...
    <div class="row">
        <div class="col-sm-8 offset-sm-2">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <a href="<?php echo $link['url']; ?>" rel="nofollow" title="<?php echo $link['title']; ?>"><span
                            class="badge badge-primary badge-pill-2"> 链 接 </span><?php echo $link['url']; ?></a>
                </li>
                <?php
                $i = 0;
                foreach ($link['url_standby'] as $key => $url_standby) {
                    ...
                    ?>
                    <li class="list-group-item">
                        <a href="<?php echo $url; ?>" rel="nofollow" title="<?php echo $link['title']; ?>"><span
                                class="badge badge-primary badge-pill-2">备用<?php echo $i; ?></span><?php echo $title; ?>
                        </a>
                    </li>
