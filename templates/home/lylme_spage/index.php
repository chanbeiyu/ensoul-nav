...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $theme_dir; ?>/css/style.css" type="text/css">
    <link rel="stylesheet" href="<?php echo $theme_dir; ?>/css/font.css" type="text/css">
    <link rel="stylesheet" href="<?php echo $theme_dir; ?>/css/tag.css" type="text/css">
    <script src="<?php echo $libs; ?>/jquery/jquery-3.5.1.min.js" type="application/javascript"></script>
    <style>.change-type .showListType {
            width: <?php echo $theme_config['changewidth'];?>px;
        }</style>
...
<div class="banner-video">
    <img src="<?php echo $theme_config['backgroundURL']; ?>">
    ...
    <div class="collapse navbar-collapse" id="navbarsExample05">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="./index.php?c=admin&u=<?php echo $u; ?>"
                                    target="_blank"><span><?php echo is_login ? '后台管理' : '登录'; ?></span></a></li>
            <?php if (is_apply()) { ?>
        ...
        <div id="search-list" class="hide-type-list">
            <div class="search-group group-a s-current" style=" margin-top: 50px;">
                <ul class="search-type">
                    ...
                    <li>
                        <input hidden="" checked="" type="radio" name="type" id="type-csdn"
                               value="https://so.csdn.net/so/search?q=" data-placeholder="CSDN搜索">
