                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-form-mid layui-word-aux" style="color: #d40909!important;">
                                    全部配色和背景图在夜间模式状态下无效！
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['HeadBackgroundColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input" id="HeadBackgroundColor-input"
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['CardBackgroundColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input" id="CardBackgroundColor-input"
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['OtherBackgroundColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input" id="OtherBackgroundColor-input"
                                           name="OtherBackgroundColor">
                                </div>
                                <div class="layui-inline" style="left: -11px;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['SidebarBackgroundColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input"
                                           id="SidebarBackgroundColor-input" name="SidebarBackgroundColor">
                                </div>
                                <div class="layui-inline" style="left: -11px;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['HeadFontColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input" id="HeadFontColor-input"
                                           name="HeadFontColor">
                                </div>
                                <div class="layui-inline" style="left: -11px;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['CategoryFontColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input" id="CategoryFontColor-input"
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['TitleFontColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input" id="TitleFontColor-input"
                                           name="TitleFontColor">
                                </div>
                                <div class="layui-inline" style="left: -11px;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="<?php echo $theme_config['DescrFontColor']; ?>"
                                           placeholder="请选择颜色" class="layui-input" id="DescrFontColor-input"
                                           name="DescrFontColor">
                                </div>
                                <div class="layui-inline" style="left: -11px;">
                            ...
                            <div class="layui-form-item">
                                <input id="PresetColor-input" type="hidden"
                                       value="<?php echo $theme_config['PresetColor']; ?>">
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item">
                                <input id="DescrRowNumber-input" type="hidden"
                                       value="<?php echo $theme_config['DescrRowNumber']; ?>">
                            ...
                            <div class="layui-form-item">
                                <input id="ClickLocation-input" type="hidden"
                                       value="<?php echo $theme_config['ClickLocation']; ?>">
                            ...
                            <div class="layui-form-item">
                                <input id="referrer-input" type="hidden"
                                       value="<?php echo $theme_config['referrer']; ?>">
                                ...
                                <div class="layui-form-mid layui-word-aux">
                                    <a target="_blank" style="color:#03a9f4!important;font-weight:bold;font-size:16px"
                                       href='https://gitee.com/tznb/OneNav/wikis/pages?sort_id=5491338&doc_id=2439895'>使用说明</a>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 73%;">
                                    <input type="url" name="backgroundURL"
                                           value="<?php echo $theme_config['backgroundURL']; ?>"
                                           placeholder="存在时其他背景色无效,请输入图片URL" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item">
                                <input id="WeatherPosition-input" type="hidden"
                                       value="<?php echo $theme_config['WeatherPosition']; ?>">
                                <label class="layui-form-label">插件位置</label>
                                <div class="layui-input-inline">
                                    <select lay-verify="required" id="WeatherPosition" name="WeatherPosition"
                                            lay-search>
                                        <option value="0">关闭</option>
                            ...
                            <div class="layui-form-item">
                                <input id="WeatherBackground-input" type="hidden"
                                       value="<?php echo $theme_config['WeatherBackground']; ?>">
                                <label class="layui-form-label">天气背景</label>
                                <div class="layui-input-inline">
                                    <select lay-verify="required" id="WeatherBackground" name="WeatherBackground"
                                            lay-search>
                            ...
                            <div class="layui-form-item">
                                <input id="WeatherFontColor-input" type="hidden"
                                       value="<?php echo $theme_config['WeatherFontColor']; ?>">
                                <label class="layui-form-label">天气字体色</label>
                                <div class="layui-input-inline">
                                    <select lay-verify="required" id="WeatherFontColor" name="WeatherFontColor"
                                            lay-search>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 50%;">
                                    <input type="url" id="WeatherKey" name="WeatherKey"
                                           value="<?php echo $theme_config['WeatherKey']; ?>" placeholder=""
                                           autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-form-mid layui-word-aux">
                                    <a target="_blank" style="color:#03a9f4!important;"
                                       href='https://widget.qweather.com/create-simple/'>申请Key</a>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['form', 'colorpicker', 'element', 'dropdown', 'background'], function () {
        ...
        form.on('select(PresetColor)', function (data) {
            ...
            if (data.value == '0') {
                ...
                data = {
                    ...
                    'CategoryFontColor': '#212121',
                    'TitleFontColor': '#212121',
                    'DescrFontColor': '#9e9e9e'
                };
                ...
                data = {
                    ...
                    'SidebarBackgroundColor': '',
                    'CardBackgroundColor': '#414141',
                    'OtherBackgroundColor': '#232323',
                    'HeadFontColor': '#f8f8f8',
                    'CategoryFontColor': '#f8f8f8',
                    'TitleFontColor': '#f8f8f8',
                    'DescrFontColor': '#d5d5d5'
                };
                ...
                data = {
                    ...
                    'CardBackgroundColor': '#414141',
                    'OtherBackgroundColor': '#232323',
                    'HeadFontColor': '#f5eb8c',
                    'CategoryFontColor': '#f5eb8c',
                    'TitleFontColor': '#f5eb8c',
                    'DescrFontColor': '#f4eca9'
                };
            } else if (data.value == '3') {
                // 浅绿护眼
                data = {
                    'HeadBackgroundColor': '#bbe6bf',
                    'SidebarBackgroundColor': '',
                    'CardBackgroundColor': '#E3EDCD',
                    'OtherBackgroundColor': '#C7EDCC',
                    'HeadFontColor': '#6f680c',
                    'CategoryFontColor': '#6f680c',
                    'TitleFontColor': '#6f680c',
                    'DescrFontColor': '#747038'
                };
            } else if (data.value == '4') {
                // 深绿护眼
                data = {
                    'HeadBackgroundColor': '#6ba628',
                    'SidebarBackgroundColor': '',
                    'CardBackgroundColor': '#abc87a',
                    'OtherBackgroundColor': '#76a650',
                    'HeadFontColor': '#373535',
                    'CategoryFontColor': '#000000',
                    'TitleFontColor': '#000000',
                    'DescrFontColor': '#3b3b36'
                };
            } else if (data.value == '5') {
                // 粉色
                data = {
                    'HeadBackgroundColor': '#efa9dd',
                    'SidebarBackgroundColor': '',
                    'CardBackgroundColor': '#e89bd4',
                    'OtherBackgroundColor': '#e4a6d3',
                    'HeadFontColor': '#6a6868',
                    'CategoryFontColor': '#6a6868',
                    'TitleFontColor': '#6a6868',
                    'DescrFontColor': '#5e5e56'
                };
            }
            form.val('form', data);
        ...
        var BackgroundColor = [{title: '全透明', code: 'transparent'}, {
            title: '白色透明',
            code: 'rgba(255,255,255,0.2)'
        }, {title: '黑色透明', code: 'rgba(0,0,0,0.2)'}]
//背景色透明选项
        dropdown.render({
            elem: '#HeadBackgroundColor-input', data: BackgroundColor, click: function (obj) {
                this.elem.val(obj.code);
            }, style: 'width: 225px;'
        });
        dropdown.render({
            elem: '#CardBackgroundColor-input', data: BackgroundColor, click: function (obj) {
                this.elem.val(obj.code);
            }, style: 'width: 225px;'
        });
        dropdown.render({
            elem: '#OtherBackgroundColor-input', data: BackgroundColor, click: function (obj) {
                this.elem.val(obj.code);
            }, style: 'width: 225px;'
        });
        dropdown.render({
            elem: '#SidebarBackgroundColor-input', data: BackgroundColor, click: function (obj) {
                this.elem.val(obj.code);
            }, style: 'width: 225px;'
        });
